...
import { Sparkles, Download, CheckCircle, FileText, Layout, Loader2 } from 'lucide-react';
    ...
    return (
      <DashboardLayout>
        <EmptyState 
          ...
          description="Create a resume to get started with ATS optimization."
        />
      </DashboardLayout>
    );
  }
          ...
          {optimizedAlert && (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <span>Resume score {activeResume.score}/100! Analysis complete.</span>
              </div>
