      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20 gap-4">
          ...
          <Link to="/" className="flex items-center gap-3 shrink-0 group">
            <div className="w-10 h-10 rounded-2xl bg-[#0F766E] text-white flex items-center justify-center shadow-md shadow-teal-900/15 group-hover:scale-105 transition-all duration-300 border border-teal-600/30">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <motion.button
              ...
              aria-label="Search"
              className="px-3 py-2 rounded-2xl bg-white/80 dark:bg-[#1A1A1A]/80 border border-stone-200 dark:border-stone-800 text-stone-600 dark:text-stone-300 hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors flex items-center gap-2.5 cursor-pointer shadow-xs"
            >
              <Search className="w-4 h-4 text-[#0F766E] dark:text-teal-400" />
              <span className="hidden md:inline text-xs font-medium text-stone-500 dark:text-stone-400 pr-1">Search...</span>
              <kbd className="hidden lg:flex items-center gap-0.5 text-[10px] font-mono px-1.5 py-0.5 rounded bg-stone-100 dark:bg-stone-900 text-stone-500 dark:text-stone-400 border border-stone-200 dark:border-stone-800">
            ...
            <button
              ...
              className="p-2.5 rounded-2xl bg-white/80 dark:bg-[#1A1A1A]/80 border border-stone-200 dark:border-stone-800 text-stone-600 dark:text-stone-300 hover:text-[#0F766E] dark:hover:text-teal-400 transition-colors cursor-pointer"
